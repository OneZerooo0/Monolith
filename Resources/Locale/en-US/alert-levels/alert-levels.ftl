...
alert-level-announcement = WARNING. Sector DEFCON level is now {CAPITALIZE($name)}. {$announcement}
...
alert-level-green = DEFCON 5 - GREEN
...
alert-level-blue = DEFCON 4 - BLUE
...
# alert-level-red = Red
alert-level-red = DEFCON 3-i - RED
...
alert-level-violet = DEFCON 3-ii - VIOLET
...
alert-level-yellow = DEFCON 3-iii - YELLOW
...
alert-level-gamma = DEFCON 2 - GAMMA
